    ...
    <div className="relative bg-[#fffdd0] py-16 px-4 flex flex-col items-center text-center">
      ...
      <div className="max-w-6xl mx-auto z-10">
        ...
        <p className="text-gray-700 text-base md:text-lg leading-relaxed">
          Tizzy Mail can be setup in automatic or manual mode on any device and
          in any email application.
          <br />
          It also has a user-friendly Webmail Interface to access from browser.
          <br />
